...
\starttabulate[|l|p|]
\HL
\NC Attribute \NC Description \NC\NR
\HL
\NC id \NC Node unique identifier (e.g., \type{jobname-1-Q-1}) \NC\NR
\NC order \NC Level order (e.g., \type{1}, \type{2-1}, \type{2-2-1}) \NC\NR
\NC answer \NC Answer content \NC\NR
\NC point \NC Current node score (valid for leaf nodes) \NC\NR
\NC totalpoint \NC Total score of this node and child nodes \NC\NR
\NC totalnumber \NC Total count of this node and child nodes \NC\NR
\NC is_leaf \NC Whether it is a leaf node \NC\NR
\NC depth \NC Node depth (0=root node) \NC\NR
\HL
\stoptabulate
...
Use \type{\UnlimitedGetAnswer} to get attributes of specified nodes:
