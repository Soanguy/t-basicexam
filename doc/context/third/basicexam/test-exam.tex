...
\question{This is the question stem of the selection question.
   \choice[n=8]{Choice One,Choice Two,Choice Three,Choice Four}
}
...
\section{Statistics Information Test}

\subsection{Answer Tree Structure Test}

\startbuffer
\startquestion[point=10,showpoint=true,answer=]
First level question with nested structure
  \startquestion[point=5,showpoint=true,answer=]
  Second level question
    \startquestion[point=2,showpoint=true,answer=A]
...
\subsection{Node Information Retrieval Test}

\startbuffer
\question[point=5,answer=A,showanswer=true,showpoint=true]{
  Question with node information \par
 \tt Current ID: \UnlimitedCurrentID \par
  Current depth: \UnlimitedGetDepth \par
  Current answer: \UnlimitedDisplayAnswer{\UnlimitedCurrentID} \par
  Current point: \UnlimitedDisplayPoint{\UnlimitedCurrentID} \par \rm
  \choice{Option A,Option B,Option C,Option D}
}
\stopbuffer
...
\subsection{Structure Level Statistics Test}

% Test current structure statistics (this is in chapter 2, section 2)
\tt
Current chapter (Chapter 2) statistics: \par
- Major questions: \UnlimitedCurrentStructureTotalNumber{1} \par
- Total points: \UnlimitedCurrentStructureTotalPoint{1} \par
- Independent major questions: \UnlimitedCurrentStructureLeafNumber{1} \par
- All sub-questions: \UnlimitedCurrentStructureAllLeafNumber{1} \par
\par
Chapter 1 statistics: \par
- Major questions: \UnlimitedStructureTotalNumber{1}{1} \par
- Total points: \UnlimitedStructureTotalPoint{1}{1} \par
- Independent major questions: \UnlimitedStructureLeafNumber{1}{1} \par
- All sub-questions: \UnlimitedStructureAllLeafNumber{1}{1} \par
\par
Chapter 2 statistics: \par
- Major questions: \UnlimitedStructureTotalNumber{1}{2} \par
- Total points: \UnlimitedStructureTotalPoint{1}{2} \par
- Independent major questions: \UnlimitedStructureLeafNumber{1}{2} \par
- All sub-questions: \UnlimitedStructureAllLeafNumber{1}{2} \par
\rm
