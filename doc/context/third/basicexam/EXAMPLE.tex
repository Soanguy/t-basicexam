...
\setuppapertitle [papertitles][
    list={secret,title,subject,information,notice},
    secretstyle=\ss,
    titlestyle=\ssa,
    subjectstyle=\ssb,
    informationstyle=\ttx,
...
\setuppitem[point=2]
\setupclose[width=2em,answerwidth=3em]
\starttext
...
\startquestion
  ...
  若 $|FQ| = 6$，则 $C$ 的准线方程为 \fillin{2} 。
\stopquestion

% 15.
\startquestion
  函数 $f(x) = |2x - 1| - 2 \ln x$ 的最小值为 \fillin{3} 。
\stopquestion
...
\startquestion
  ...
  以此类推。则对折 $4$ 次共可以得到不同规格图形的种数为 \fillin{4} ；
...
Not all great writers are great spellers. If you want to be published, it's vital to submit a perfect, professionally presented manuscript (原稿). \ocitem[answer=F]{} No editor is likely to tolerate a writer who does not take the trouble to spell words correctly.
I keep two reference books close-by on my desk: dictionary and thesaurus (同义词词典). I don't trust my laptop's spellchecker. \ocitem[answer=B]{} Of course, these days there are plenty of online dictionaries and thesauruses, but I'm old-fashioned enough to prefer a hard cover and pages I can leaf through with my fingers. I use the Concise Oxford Dictionary and the Collins Thesaurus.
\ocitem[answer=E]{} It should give you a precise definition of each word, thus differentiating it from other words whose meanings are similar, but not identical. It will also usually show how the word is pronounced.
In addition, I have an old two-volume copy of the Shorter Oxford Dictionary, picked up a few years ago in a bookshop sale for just 99 pence. Of course, with its 2,672 pages, it's not exactly short. It contains around 163,000 words, plus word combinations and idiomatic phrases. \ocitem[answer=A]{} However, if I need to check the origin of a word or to look up examples of its usage, there's nothing better.
...
\ocitem[answer=D]{} A few minutes spent casting your eye over a page or two can be a rewarding experience.
...
%\typeanswertable[2,5][1][1]
%\typeanswertable[2,5][2][1]
%\typeanswertable[11,5][3][1]
%\typeanswertable[1,5][3][56]
