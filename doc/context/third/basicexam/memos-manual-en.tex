\usemodule[memos][mainlanguage=en,language=en,extra=all]
\usemodule[setups]
...
\protected\def\colorshowtemp#1{%
  \framed[foregroundcolor=#1,frame=off,align={lohi},foregroundstyle=\ttx]{#1}}

\protected\def\bgcolorshowtemp#1{%
  \framed[foregroundcolor=white,background=color,backgroundcolor=#1,
           frame=off,align={lohi},foregroundstyle=\ttx]{#1}}

\def\showcolorlevels{%
  \starttabulate[|lw(.15\textwidth)|cw(.15\textwidth)|cw(.15\textwidth)|cw(.15\textwidth)|cw(.15\textwidth)|cw(.15\textwidth)|]
  \HL
  \NC \NC \ttx red \NC \ttx blue \NC \ttx green \NC \ttx yellow \NC \ttx cyan \NC\NR
  \HL
  \NC \ttx pale   \NC \colorshowtemp{palered}   \NC \colorshowtemp{paleblue}   \NC \colorshowtemp{palegreen}   \NC \colorshowtemp{paleyellow}   \NC \colorshowtemp{palecyan}   \NC\NR
  \NC \ttx soft   \NC \colorshowtemp{softred}   \NC \colorshowtemp{softblue}   \NC \colorshowtemp{softgreen}   \NC \colorshowtemp{softyellow}   \NC \colorshowtemp{softcyan}   \NC\NR
  \NC \ttx light  \NC \colorshowtemp{lightred}  \NC \colorshowtemp{lightblue}  \NC \colorshowtemp{lightgreen}  \NC \colorshowtemp{lightyellow}  \NC \colorshowtemp{lightcyan}  \NC\NR
  \NC \ttx normal \NC \colorshowtemp{red}       \NC \colorshowtemp{blue}       \NC \colorshowtemp{green}       \NC \colorshowtemp{yellow}       \NC \colorshowtemp{cyan}       \NC\NR
  \NC \ttx dark   \NC \colorshowtemp{darkred}   \NC \colorshowtemp{darkblue}   \NC \colorshowtemp{darkgreen}   \NC \colorshowtemp{darkyellow}   \NC \colorshowtemp{darkcyan}   \NC\NR
  \NC \ttx deep   \NC \colorshowtemp{deepred}   \NC \colorshowtemp{deepblue}   \NC \colorshowtemp{deepgreen}   \NC \colorshowtemp{deepyellow}   \NC \colorshowtemp{deepcyan}   \NC\NR
  \NC \ttx black  \NC \colorshowtemp{blackred}  \NC \colorshowtemp{blackblue}  \NC \colorshowtemp{blackgreen}  \NC \colorshowtemp{blackyellow}  \NC \colorshowtemp{blackcyan}  \NC\NR
  \HL
  \stoptabulate
  \starttabulate[|lw(.19\textwidth)|cw(.19\textwidth)|cw(.19\textwidth)|cw(.19\textwidth)|cw(.19\textwidth)|]
  \HL
  \NC              \NC \ttx orange \NC \ttx purple \NC \ttx pink \NC \ttx gray \NC\NR
  \HL
  \NC \ttx pale   \NC \colorshowtemp{paleorange}   \NC \colorshowtemp{palepurple}   \NC \colorshowtemp{palepink}   \NC \colorshowtemp{palegray}   \NC\NR
  \NC \ttx soft   \NC \colorshowtemp{softorange}   \NC \colorshowtemp{softpurple}   \NC \colorshowtemp{softpink}   \NC \colorshowtemp{softgray}   \NC\NR
  \NC \ttx light  \NC \colorshowtemp{lightorange}  \NC \colorshowtemp{lightpurple}  \NC \colorshowtemp{lightpink}  \NC \colorshowtemp{lightgray}  \NC\NR
  \NC \ttx normal \NC \colorshowtemp{orange}       \NC \colorshowtemp{purple}      \NC \colorshowtemp{pink}       \NC \colorshowtemp{gray}       \NC\NR
  \NC \ttx dark   \NC \colorshowtemp{darkorange}   \NC \colorshowtemp{darkpurple}   \NC \colorshowtemp{darkpink}   \NC \colorshowtemp{darkgray}   \NC\NR
  \NC \ttx deep   \NC \colorshowtemp{deeporange}   \NC \colorshowtemp{deeppurple}   \NC \colorshowtemp{deeppink}   \NC \colorshowtemp{deepgray}   \NC\NR
  \NC \ttx black  \NC \colorshowtemp{blackorange}  \NC \colorshowtemp{blackpurple}  \NC \colorshowtemp{blackpink}  \NC \colorshowtemp{blackgray}  \NC\NR
  \HL
  \stoptabulate
  }

\def\showbgcolorlevels{%
  \starttabulate[|lw(.15\textwidth)|cw(.15\textwidth)|cw(.15\textwidth)|cw(.15\textwidth)|cw(.15\textwidth)|cw(.15\textwidth)|]
  \HL
  \NC \NC \ttx red \NC \ttx blue \NC \ttx green \NC \ttx yellow \NC \ttx cyan \NC\NR
  \HL
  \NC \ttx pale   \NC \bgcolorshowtemp{palered}   \NC \bgcolorshowtemp{paleblue}   \NC \bgcolorshowtemp{palegreen}   \NC \bgcolorshowtemp{paleyellow}   \NC \bgcolorshowtemp{palecyan}  \NC\NR
  \NC \ttx soft   \NC \bgcolorshowtemp{softred}   \NC \bgcolorshowtemp{softblue}   \NC \bgcolorshowtemp{softgreen}   \NC \bgcolorshowtemp{softyellow}   \NC \bgcolorshowtemp{softcyan}  \NC\NR
  \NC \ttx light  \NC \bgcolorshowtemp{lightred}  \NC \bgcolorshowtemp{lightblue}  \NC \bgcolorshowtemp{lightgreen}  \NC \bgcolorshowtemp{lightyellow}  \NC \bgcolorshowtemp{lightcyan} \NC\NR
  \NC \ttx normal \NC \bgcolorshowtemp{red}       \NC \bgcolorshowtemp{blue}       \NC \bgcolorshowtemp{green}       \NC \bgcolorshowtemp{yellow}       \NC \bgcolorshowtemp{cyan}      \NC\NR
  \NC \ttx dark   \NC \bgcolorshowtemp{darkred}   \NC \bgcolorshowtemp{darkblue}   \NC \bgcolorshowtemp{darkgreen}   \NC \bgcolorshowtemp{darkyellow}   \NC \bgcolorshowtemp{darkcyan}  \NC\NR
  \NC \ttx deep   \NC \bgcolorshowtemp{deepred}   \NC \bgcolorshowtemp{deepblue}   \NC \bgcolorshowtemp{deepgreen}   \NC \bgcolorshowtemp{deepyellow}   \NC \bgcolorshowtemp{deepcyan}  \NC\NR
  \NC \ttx black  \NC \bgcolorshowtemp{blackred}  \NC \bgcolorshowtemp{blackblue}  \NC \bgcolorshowtemp{blackgreen}  \NC \bgcolorshowtemp{blackyellow}  \NC \bgcolorshowtemp{blackcyan} \NC\NR
  \HL
  \stoptabulate
  \starttabulate[|lw(.19\textwidth)|cw(.19\textwidth)|cw(.19\textwidth)|cw(.19\textwidth)|cw(.19\textwidth)|]
  \HL
  \NC              \NC \ttx orange \NC \ttx purple \NC \ttx pink \NC \ttx gray \NC\NR
  \HL
  \NC \ttx pale   \NC \bgcolorshowtemp{paleorange}   \NC \bgcolorshowtemp{palepurple}   \NC \bgcolorshowtemp{palepink}   \NC \bgcolorshowtemp{palegray}   \NC\NR
  \NC \ttx soft   \NC \bgcolorshowtemp{softorange}   \NC \bgcolorshowtemp{softpurple}   \NC \bgcolorshowtemp{softpink}   \NC \bgcolorshowtemp{softgray}   \NC\NR
  \NC \ttx light  \NC \colorshowtemp{lightorange}    \NC \colorshowtemp{lightpurple}    \NC \colorshowtemp{lightpink}    \NC \colorshowtemp{lightgray}    \NC\NR
  \NC \ttx normal \NC \bgcolorshowtemp{orange}       \NC \bgcolorshowtemp{purple}       \NC \bgcolorshowtemp{pink}       \NC \bgcolorshowtemp{gray}       \NC\NR
  \NC \ttx dark   \NC \bgcolorshowtemp{darkorange}   \NC \bgcolorshowtemp{darkpurple}   \NC \bgcolorshowtemp{darkpink}   \NC \bgcolorshowtemp{darkgray}   \NC\NR
  \NC \ttx deep   \NC \bgcolorshowtemp{deeporange}   \NC \bgcolorshowtemp{deeppurple}   \NC \bgcolorshowtemp{deeppink}   \NC \bgcolorshowtemp{deepgray}   \NC\NR
  \NC \ttx black  \NC \bgcolorshowtemp{blackorange}  \NC \bgcolorshowtemp{blackpurple}  \NC \bgcolorshowtemp{blackpink}  \NC \bgcolorshowtemp{blackgray}  \NC\NR
  \HL
  \stoptabulate
  }

\def\showpaletcolors{%
  \starttabulate[|lw(.24\textwidth)|lw(.24\textwidth)|lw(.24\textwidth)|lw(.24\textwidth)|]
  \HL
  \NC Color Name \NC Example \NC Color Name \NC Example \NC\NR
  \HL
  \NC \ttx titlecolor \NC \colorshowtemp{titlecolor} \NC
      \ttx textcolor \NC \colorshowtemp{textcolor} \NC\NR
  \NC \ttx codecolor \NC \colorshowtemp{codecolor} \NC
      \ttx captioncolor \NC \colorshowtemp{captioncolor} \NC\NR
  \NC \ttx footnotecolor \NC \colorshowtemp{footnotecolor} \NC
      \ttx linkcolor \NC \colorshowtemp{linkcolor} \NC\NR
  \NC \ttx toccolor \NC \colorshowtemp{toccolor} \NC
      \ttx referencecolor \NC \colorshowtemp{referencecolor} \NC\NR
  \NC \ttx optcolor \NC \colorshowtemp{optcolor} \NC
      \ttx lightoptcolor \NC \colorshowtemp{lightoptcolor} \NC\NR
  \NC \ttx softbackground \NC \bgcolorshowtemp{softbackground} \NC
      \ttx darkbackground \NC \bgcolorshowtemp{darkbackground} \NC\NR
  \NC \ttx palethemecolor \NC \bgcolorshowtemp{palethemecolor} \NC
      \ttx softthemecolor \NC \bgcolorshowtemp{softthemecolor} \NC\NR
  \NC \ttx lightthemecolor \NC \bgcolorshowtemp{lightthemecolor} \NC
      \ttx themecolor \NC \bgcolorshowtemp{themecolor} \NC\NR
  \NC \ttx darkthemecolor \NC \bgcolorshowtemp{darkthemecolor} \NC
      \ttx deepthemecolor \NC \bgcolorshowtemp{deepthemecolor} \NC\NR
  \HL
  \stoptabulate}
...
\def\showallpalettes{%
  \doloopoverlist
    ...
    {\subject{\recursestring}\par\setuppalet[\recursestring]\showpaletcolors\blank[medium]}}
...
\setuplist[content][list={part,title,chapter,section,subsection}]
\placecontent
...
For detailed descriptions and demonstrations of each parameter, see the corresponding chapters:

\startitemize[packed]
\item Paper size and page layout: \goto{Chapter 5 Page Layout}[page:layout]
\item Font settings: \goto{Chapter 4 Font System}[page:font]
\item Theme color: \goto{Chapter 6 Color System}[page:color]
\item Chapter title style: \goto{Chapter 7 Chapter Style}[page:chapter]
\item Header/footer style: \goto{Chapter 8 Header/Footer}[page:headerfooter]
\item TOC style: \goto{Chapter 9 Table of Contents}[page:toc]
\stopitemize
...
\pagereference[page:color]
\setuplayout[narrow]

\section{Base Color Set}

The module predefines 11 base colors, each with 7 levels (pale/soft/light/normal/dark/deep/black):
...
Each theme color has 7 level variants forming a complete color system:

\starttabulate[|l|p|]
\HL
\NC Color Variant \NC Description \NC\NR
\HL
\NC palethemecolor \NC Pale theme color \NC\NR
...
\NC blackthemecolor \NC Black theme color \NC\NR
\HL
...
\NC toccolor \NC TOC color \NC\NR
...
\HL
\stoptabulate
\page\setuplayout[default]

\chapter{Header/Footer}

\pagereference[page:headerfooter]
...
\chapter{Pinyin Annotation}

\section{Introduction}

The pinyin annotation feature automatically or manually adds pinyin (romanization) to Chinese characters, suitable for educational materials and language learning documents.

\section{Loading the Module}

\starttyping
\usemodule[memos][extra=pinyin]
% or load all extra features
\usemodule[memos][extra=all]
\stoptyping

\section{Automatic Annotation Environment}

Use the \type{startpinyinscope} environment to automatically add pinyin to Chinese characters:
...
Use the \type{\xpinyin} command to add pinyin to specific characters:

\startbuffer
汉字：\xpinyin{手动注音测试}

手动指定拼音：\xpinyin[hàn]{汉}
\stopbuffer
...
\section{Polyphonic Character Handling}

\subsection{Manually Specifying Polyphonic Characters}
...
\subsection{Polyphonic Character Marking Mode}

Enable \type{markpolyphone=yes} to mark polyphonic characters:
...
Use \type{\setuppinyin} to set pinyin parameters:

\starttabulate[|l|l|p(8cm)|]
\HL
\NC Parameter \NC Default \NC Description \NC\NR
\HL
\NC vsep \NC 1em \NC Vertical spacing between pinyin and character \NC\NR
\NC hsep \NC 0pt \NC Horizontal spacing between pinyin characters \NC\NR
\NC pysep \NC \tex{spaceskip} \NC Spacing between pinyin syllables \NC\NR
\NC ratio \NC 4 \NC Pinyin font size ratio (relative to character) \NC\NR
\NC multiple \NC no \NC Whether to show polyphonic options \NC\NR
\NC markpolyphone \NC no \NC Whether to mark polyphonic characters \NC\NR
\HL
\stoptabulate

\subsection{Parameter Examples}

\startbuffer
% Adjust pinyin size
\xpinyin[ratio=6]{汉}  % larger
\xpinyin[ratio=3]{汉}  % smaller

% Adjust vertical spacing
\xpinyin[vsep=2em]{汉字}

% Show polyphonic options
\xpinyin[multiple=yes]{重庆}
\stopbuffer

\typebuffer

\chapter{Stroke Display}

\bihuaload{好学习}

\section{Introduction}

The stroke display feature shows the stroke order and structure of Chinese characters, suitable for character teaching and calligraphy practice.
...
\subsection{Loading Character Data}

Before using stroke features, load character data:

\starttyping
\bihuaload{好学习}
\stoptyping

\subsection{Displaying Single Stroke}

Use \type{\bihuashow} to display a specific stroke:

\startbuffer
% Display the 3rd stroke of "好"
\bihuashow{好}{3}
...
The module provides various frame types:

\starttabulate[|l|p(8cm)|]
\HL
\NC Type \NC Description \NC\NR
\HL
\NC outer \NC Outer frame only \NC\NR
\NC tian \NC Tian character grid (cross lines) \NC\NR
\NC outertian \NC Outer frame + Tian grid \NC\NR
\NC mi \NC Mi character grid (cross + diagonal lines) \NC\NR
\NC outermi \NC Outer frame + Mi grid \NC\NR
\NC x \NC Diagonal lines only \NC\NR
\NC outerx \NC Outer frame + diagonal lines \NC\NR
\NC none \NC No frame \NC\NR
\HL
\stoptabulate

\subsection{Frame Examples}
...
% Mi grid
\bihuashow[frame=outermi]{好}{3}

% No frame
\bihuashow[frame=none]{好}{3}
\stopbuffer
...
\NC Parameter \NC Default \NC Description \NC\NR
\HL
\NC width \NC 1cm \NC Drawing width \NC\NR
\NC frame \NC outer \NC Frame type \NC\NR
\NC natural \NC no \NC Use natural width \NC\NR
\NC framestroke \NC black \NC Frame line color \NC\NR
\NC framefill \NC (none) \NC Frame fill color \NC\NR
\NC framelinewidth \NC 0.5pt \NC Frame line width \NC\NR
\NC framedashpattern \NC solid \NC Frame line style (solid/dashed/dotted) \NC\NR
\NC iframestroke \NC 0.5white \NC Inner frame line color \NC\NR
\NC iframelinewidth \NC 0.3pt \NC Inner frame line width \NC\NR
\NC iframedashpattern \NC dashed \NC Inner frame line style \NC\NR
\NC charstroke \NC black \NC Character line color \NC\NR
\NC charfill \NC black \NC Character fill color \NC\NR
\NC charlinewidth \NC 0.3pt \NC Character line width \NC\NR
\NC chardashpattern \NC solid \NC Character line style \NC\NR
\NC laststroke \NC red \NC Last stroke line color \NC\NR
\NC lastfill \NC red \NC Last stroke fill color \NC\NR
\NC lastlinewidth \NC 0.3pt \NC Last stroke line width \NC\NR
\NC lastdashpattern \NC solid \NC Last stroke line style \NC\NR
\NC innert \NC 0pt \NC Top inner padding \NC\NR
\NC innerb \NC 0pt \NC Bottom inner padding \NC\NR
\NC innerl \NC 0pt \NC Left inner padding \NC\NR
\NC innerr \NC 0pt \NC Right inner padding \NC\NR
\NC inner \NC (none) \NC Unified inner padding \NC\NR
\NC spacing \NC 0em \NC Character spacing (for \type{\bihuashowall} only) \NC\NR
\HL
\stoptabulate
...
\startbuffer
% Custom size
\bihuashow[width=2cm]{好}{3}

% Custom colors
\bihuashow[framestroke=red,charfill=blue]{好}{3}

% Custom padding
\bihuashow[inner=10pt]{好}{3}

% Display all strokes with spacing
\bihuashowall[spacing=0.5cm]{好学习}
\stopbuffer
...
Use \type{\definebihua} to define new styles:

\startbuffer
% Define red style
\definebihua[redstyle][bihua][
  frame=outer,
  framestroke=red,
  charfill=red,
  laststroke=blue,
...
\section{Stroke Teaching Example}

\startbuffer
% Display strokes progressively
\bihuashow[width=1.5cm,frame=outertian]{好}{1}
\bihuashow[width=1.5cm,frame=outertian]{好}{2}
\bihuashow[width=1.5cm,frame=outertian]{好}{3}
\bihuashow[width=1.5cm,frame=outertian]{好}{4}
\bihuashow[width=1.5cm,frame=outertian]{好}{5}
\bihuashow[width=1.5cm,frame=outertian]{好}{6}
\stopbuffer
