...
\startbuffer
% List format (default)
\typeanswer[start=1,total=5]{}

% Table format
\typeanswer[method=table,start=1,total=10,rows=2,columns=5]{}

% Table alt format
\typeanswer[method=table,layout=alt,start=1,total=10,rows=5,columns=2]{}

% Direct access
\typeanswer[method=direct]{0-Q-5}
\stopbuffer
...
\typeanswer[start=1,total=5,separator={; }]{}

\typeanswer[start=1,total=5,showid=no]{}
\stopbuffer
